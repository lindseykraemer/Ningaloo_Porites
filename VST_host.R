...
#(Cladocopium taxa: C15 variants (Orange / Yellow /neutral Tones), Thermotolerant Types (Red Tones), Thermosensitive Types (Blue Tones), Unknown Thermal Tolerance (Green Tones))
ASV_colors <- c(
  "C116"   = "#C73E1D",
  "C15"    = "#F3E6C8",
  "C15.1"  = "#FFF4E1",
